...
<head>
    ...
    <title>TechStore - Tienda de Informática</title>
        ...
        <div class="filtros">
            ...
            <form method="GET" action="index.php">
                ...
                <?php if (isset($_GET['categoria']) || isset($_GET['buscar'])): ?>
                    <a href="index.php" class="btn btn-secondary" style="display: inline-block; width: auto; padding: 8px 20px;">Limpiar filtros</a>
                <?php endif; ?>
            </form>
        </div>
